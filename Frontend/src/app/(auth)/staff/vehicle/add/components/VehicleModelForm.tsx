...
export default function VehicleModelForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('images with descriptions:', imagesWithDescriptions.length);
    ...
    <form onSubmit={handleSubmit} className="p-6 space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <Label className="flex items-center gap-2">
            <Upload className="w-4 h-4" /> Vehicle Images with Descriptions
          </Label>
          <Button
            type="button"
            variant="outline"
        ...
        <p className="text-xs text-gray-500">
          Upload images and add descriptions for each image. Large images (&gt;2MB or &gt;1920×1080) will be automatically compressed for optimal performance.
        </p>
        ...
        {imagesWithDescriptions.length === 0 && !isProcessingImages && (
          <div className="border-2 border-dashed border-gray-200 rounded-lg p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Click "Add Images" to upload vehicle photos with descriptions
            </p>
