...
export default function CreateRolePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(`Role "${name.trim()}" created successfully.`);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Define a new role with a specific set of permissions.
        </p>
      </div>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g. Senior Staff, Fleet Manager"
                  maxLength={100}
                />
              </div>
              <div className="space-y-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Choose the base role. This determines available permissions.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs value={baseRole} onValueChange={(v) => setBaseRole(v as 'STAFF' | 'ADMIN')}>
                ...
                <TabsContent value="STAFF">
                  <p className="text-sm text-muted-foreground mt-2">
                    Staff roles have access to vehicle, brand, feature, and booking management permissions.
                  </p>
                </TabsContent>
      ...
      <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Please confirm the new role details.
            </DialogDescription>
          </DialogHeader>
