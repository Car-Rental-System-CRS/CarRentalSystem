        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-4xl font-bold mb-6 hover:underline cursor-pointer">
              Want to know more <br /> about EcoDrive?
            </h2>

            <p className="text-gray-600 mb-8 leading-relaxed max-w-xl">
              EcoDrive connects customers who need to rent cars with thousands of
              car owners in Ho Chi Minh City, Hanoi, and other provinces. EcoDrive
